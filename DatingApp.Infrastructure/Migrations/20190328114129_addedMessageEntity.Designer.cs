...
namespace DatingApp.Infrastructure.Migrations
{
    ...
    [Migration("20190328114129_addedMessageEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatingApp.Core.Identity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DatingApp.Core.Entities.Like", b =>
                {
                    b.HasOne("DatingApp.Core.Identity.ApplicationUser", "Likee")
                        .WithMany("Likers")
                        .HasForeignKey("LikeeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DatingApp.Core.Identity.ApplicationUser", "Liker")
                        .WithMany("Likees")
            ...
            modelBuilder.Entity("DatingApp.Core.Entities.Message", b =>
                {
                    b.HasOne("DatingApp.Core.Identity.ApplicationUser", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DatingApp.Core.Identity.ApplicationUser", "Sender")
